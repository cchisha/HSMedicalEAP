...
namespace HealthSourceMedicalApp.Common
{
    public static class SharedPush
    {
        ...
        public static void Initialize()
        {
            ...
            {
                Application.Current.Properties["playerID"] = playerID;
                Application.Current.Properties["pushToken"] = pushToken;
                //Debug.WriteLine("OneSignal.Current.IdsAvailable111.....................:D playerID: {0}, pushToken: {1}", playerID, pushToken);
            });
        }
